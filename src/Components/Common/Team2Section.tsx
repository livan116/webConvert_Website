...
const teamMembers = [
  {
    ...
    socials: [
      { icon: "src/assets/img/icons/facebook1.svg", link: "#" },
      { icon: "src/assets/img/icons/instagram3.svg", link: "#" },
      { icon: "src/assets/img/icons/linkedin2.svg", link: "#" },
      { icon: "src/assets/img/icons/twitter1.svg", link: "#" },
    ],
  },
  {
    name: "Jane Smith",
