...
const Footer4: React.FC = () => {
  const socialLinks = [
    { href: "#", src: "src/assets/img/icons/facebook5.svg", alt: "Facebook" },
    { href: "#", src: "src/assets/img/icons/instagram5.png", alt: "Instagram" },
    { href: "#", src: "src/assets/img/icons/linkedin5.svg", alt: "LinkedIn" },
    { href: "#", src: "src/assets/img/icons/youtube1.svg", alt: "YouTube" },
  ];
        ...
        <Row>
          <Col lg={3} md={6}>
            <div className="footer-logo-area">
              <img src="src/assets/img/logo/logo7.png" alt="Logo" />
              <p>
