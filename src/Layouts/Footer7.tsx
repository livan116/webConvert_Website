...
const Footer7: React.FC = () => {
  const socialLinks = [
    { href: "#", src: "src/assets/img/icons/facebook6.svg", alt: "Facebook" },
    { href: "#", src: "src/assets/img/icons/instagram6.svg", alt: "Instagram" },
    { href: "#", src: "src/assets/img/icons/linkedin6.svg", alt: "LinkedIn" },
    { href: "#", src: "src/assets/img/icons/twitter6.svg", alt: "Twitter" },
  ];
        ...
        <Row>
          <Col lg={3} md={6}>
            <div className="footer-logo-area">
              <img src="src/assets/img/logo/logo8.png" alt="Logo" />
              <p>
