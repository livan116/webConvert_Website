...
const Footer2: React.FC = () => {
    const socialLinks = [
        { href: "#", src: "src/assets/img/icons/facebook.svg", alt: "Facebook" },
        { href: "#", src: "src/assets/img/icons/instagram.svg", alt: "Instagram" },
        { href: "#", src: "src/assets/img/icons/linkedin.svg", alt: "LinkedIn" },
        { href: "#", src: "src/assets/img/icons/youtube.svg", alt: "YouTube" }
    ];
                    ...
                    <Col lg={3} md={6}>
                        <div className="footer-logo-area2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">
                                        <img src="src/assets/img/icons/location.svg" alt="Location" />
                                        <span>
