...
const Footer5: React.FC = () => {
  const socialLinks = [
    { href: "#", src: "src/assets/img/icons/facebook3.svg", alt: "Facebook" },
    { href: "#", src: "src/assets/img/icons/instagram3.svg", alt: "Instagram" },
    { href: "#", src: "src/assets/img/icons/linkedin2.svg", alt: "LinkedIn" },
    { href: "#", src: "src/assets/img/icons/twitter2.svg", alt: "Twitter" },
  ];
        ...
        <Row>
          <Col lg={3} md={6}>
            <div className="footer-logo-area">
              <img src="src/assets/img/logo/logo3.png" alt="Logo" />
              <p>
